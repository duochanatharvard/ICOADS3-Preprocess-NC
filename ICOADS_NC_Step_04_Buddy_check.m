% sbatch --account=huybers_lab  -J ICOADS_buddy_check  -t 10080 -p huce_intel,huce_cascade -n 1  --mem-per-cpu=20000  --array=1-172  -o err --wrap='matlab -nosplash -nodesktop -nodisplay -r "yr=$SLURM_ARRAY_TASK_ID+1849;  for mon = 1:12,  ICOADS_NC_Step_04_Buddy_check(yr,mon); end;quit;">>log'
% 
% ICOADS_NC_Step_04_Buddy_check(yr,mon)
%
...
function ICOADS_NC_Step_04_Buddy_check(yr,mon)
