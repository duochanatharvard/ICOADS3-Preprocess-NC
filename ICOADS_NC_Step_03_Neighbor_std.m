% sbatch --account=huybers_lab  -J ICOADS_nc_std_SST -t 10080 -p huce_intel,huce_cascade -n 1  --mem-per-cpu=20000  --array=1  -o err --wrap='matlab -nosplash -nodesktop -nodisplay -r "yr=$SLURM_ARRAY_TASK_ID+1849;  id = 1; ICOADS_NC_Step_03_Neighbor_std(id); quit;">>log'
% sbatch --account=huybers_lab  -J ICOADS_nc_std_AT  -t 10080 -p huce_intel,huce_cascade -n 1  --mem-per-cpu=20000  --array=1  -o err --wrap='matlab -nosplash -nodesktop -nodisplay -r "yr=$SLURM_ARRAY_TASK_ID+1849;  id = 2; ICOADS_NC_Step_03_Neighbor_std(id); quit;">>log'
% 
% ICOADS_NC_Step_03_Neighbor_std(id)
%
...
function ICOADS_NC_Step_03_Neighbor_std(id)
    ...
    addpath('/n/home10/dchan/Matlab_Tool_Box/CD_Figures/') % directory of m_proj_nml.m 
    addpath('/n/home10/dchan/Matlab_Tool_Box/m_map/')      % directory of m_map toolbox
