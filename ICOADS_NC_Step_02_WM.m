% sbatch --account=huybers_lab  -J ICOADS_nc_WM_SST -t 10080 -p huce_intel,huce_cascade -n 1  --mem-per-cpu=20000  --array=1-172  -o err --wrap='matlab -nosplash -nodesktop -nodisplay -r "yr=$SLURM_ARRAY_TASK_ID+1849;  id = 1; for mon = 1:12,  ICOADS_NC_Step_02_WM(yr,mon,id); end;quit;">>log'
% sbatch --account=huybers_lab  -J ICOADS_nc_WM_AT  -t 10080 -p huce_intel,huce_cascade -n 1  --mem-per-cpu=20000  --array=1-172  -o err --wrap='matlab -nosplash -nodesktop -nodisplay -r "yr=$SLURM_ARRAY_TASK_ID+1849;  id = 2; for mon = 1:12,  ICOADS_NC_Step_02_WM(yr,mon,id); end;quit;">>log'
% sbatch --account=huybers_lab  -J ICOADS_nc_WM_AT  -t 10080 -p huce_intel,huce_cascade -n 1  --mem-per-cpu=20000  --array=1-60  -o err --wrap='matlab -nosplash -nodesktop -nodisplay -r "num=$SLURM_ARRAY_TASK_ID;  id = 2; [yr,mon] = ind2sub([5,12],num);  ICOADS_NC_Step_02_WM(yr+1941,mon,id);quit;">>log'
%
% 
% ICOADS_NC_Step_02_WM(yr, mon, varname)
%
...
% Debug: ICOADS_NC_Step_02_WM(1950, 1, 'NMAT')


function ICOADS_NC_Step_02_WM(yr, mon, id)
